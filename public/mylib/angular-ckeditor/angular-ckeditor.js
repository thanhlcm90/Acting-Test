/**
 * directive for ckeditor, modified by ThanhLCM
 * 
...
(function(root, factory) {
        ...
        return {
            ...
            link: function(scope, element, attrs, ctrls) {
                ...
                ckeditor.ready().then(function initialize() {
                    ...
                    scope.$watch('optHeight', function(newValue) {
                        if (newValue) {
                            ckeditor.resize(newValue);
                        }
                    });
                });
    ...
    function ckeditorController($scope, $element, $parse, $q) {
        // Create editor instance.
        var config = $scope.ckeditor || {};
